...
enum eActionOp_CONTROL: uint8_t {
    ...
    ACTION_CONTROL_AGENT_STATUS = 0x94, // MORSE_MICRO
#endif    
    ACTION_CONTROL_ENUM_END = 0x95,
};
...
enum eActionOp_BACKHAUL: uint8_t {
    ...
    ACTION_BACKHAUL_HOSTAP_SPATIAL_REUSE_REPORT_NOTIFICATION = 0x45,
    ...
    ACTION_BACKHAUL_RECONNECT_COMMAND = 0x51,
    ACTION_BACKHAUL_ENUM_END = 0x52,
};
...
enum eActionOp_APMANAGER: uint8_t {
    ...
    ACTION_APMANAGER_HOSTAP_SERVICE_PRIO_CONFIG = 0x24,
    ACTION_APMANAGER_HOSTAP_SPATIAL_REUSE_REPORT_NOTIFICATION = 0x25,
...
enum eActionOp_MONITOR: uint8_t {
    ...
    ACTION_MONITOR_CLIENT_UNASSOCIATED_STA_LINK_METRIC_REQUEST = 0x2a,
    ACTION_MONITOR_CLIENT_UNASSOCIATED_STA_LINK_METRIC_RESPONSE = 0x2b,
...
enum eActionOp_BML: uint8_t {
    ...
    ACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST = 0xe9,
    ACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST = 0xea,
    ACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST = 0xeb,
    ACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE = 0xec,
    ACTION_BML_UNASSOC_STA_RCPI_QUERY_REQUEST = 0xed,
    ACTION_BML_UNASSOC_STA_RCPI_QUERY_RESPONSE = 0xee,
    ACTION_BML_GET_UNASSOC_STA_QUERY_RESULT_REQUEST = 0xef,
    ACTION_BML_GET_UNASSOC_STA_QUERY_RESULT_RESPONSE = 0xf0,
	ACTION_BML_AGENT_STATUS_REQUEST = 0xf1, // MORSE_MICRO
    ACTION_BML_AGENT_STATUS_RESPONSE = 0xf2, //MORSE_MICRO
    ACTION_BML_ENUM_END = 0xf3,
};
