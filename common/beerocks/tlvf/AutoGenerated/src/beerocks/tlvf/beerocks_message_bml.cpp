...
sMacAddr& cACTION_BML_TRIGGER_CHANNEL_SELECTION_REQUEST::radio_mac() {
    return (sMacAddr&)(*m_radio_mac);
}

uint8_t& cACTION_BML_TRIGGER_CHANNEL_SELECTION_REQUEST::channel() {
    return (uint8_t&)(*m_channel);
}

beerocks::eWiFiBandwidth& cACTION_BML_TRIGGER_CHANNEL_SELECTION_REQUEST::bandwidth() {
    return (beerocks::eWiFiBandwidth&)(*m_bandwidth);
}

uint8_t& cACTION_BML_TRIGGER_CHANNEL_SELECTION_REQUEST::csa_count() {
...
cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::~cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE() {
}
uint8_t& cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::code() {
    return (uint8_t&)(*m_code);
}

void cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(uint8_t); // code
    return class_size;
}

bool cACTION_BML_TRIGGER_CHANNEL_SELECTION_RESPONSE::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
    }
    m_code = reinterpret_cast<uint8_t*>(m_buff_ptr__);
    if (!buffPtrIncrementSafe(sizeof(uint8_t))) {
        LOG(ERROR) << "buffPtrIncrementSafe(" << std::dec << sizeof(uint8_t) << ") Failed!";
        return false;
    }
...
cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST::cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST::cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST::~cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST() {
}
sMacAddr& cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST::mac_address() {
...
size_t cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST::get_initial_size()
{
    size_t class_size = 0;
...
bool cACTION_BML_ADD_UNASSOCIATED_STATION_STATS_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST::cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST::cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST::~cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST() {
}
sMacAddr& cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST::mac_address() {
    return (sMacAddr&)(*m_mac_address);
}
...
size_t cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(sMacAddr); // mac_address
    class_size += sizeof(sMacAddr); // agent_mac_address
...
bool cACTION_BML_REMOVE_UNASSOCIATED_STATION_STATS_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST::cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST::cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST::~cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST() {
}
void cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST::get_initial_size()
{
    size_t class_size = 0;
    return class_size;
}

bool cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::~cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE() {
}
uint8_t& cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::sta_list_length() {
    return (uint8_t&)(*m_sta_list_length);
}

std::tuple<bool, sStaMetrics&> cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::sta_list(size_t idx) {
...
bool cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::alloc_sta_list(size_t count) {
    if (m_lock_order_counter__ > 0) {;
...
void cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
...
bool cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::get_initial_size()
{
    size_t class_size = 0;
...
bool cACTION_BML_GET_UNASSOCIATED_STATIONS_STATS_RESPONSE::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::~cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST() {
}
sMacAddr& cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::sta_mac() {
    return (sMacAddr&)(*m_sta_mac);
}

void cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
    m_sta_mac->struct_swap();
}

bool cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(sMacAddr); // sta_mac
    return class_size;
...
bool cACTION_BML_CLIENT_CLEAR_CLIENT_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::~cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE() {
}
uint8_t& cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::result() {
    return (uint8_t&)(*m_result);
}

void cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(uint8_t); // result
    return class_size;
...
bool cACTION_BML_CLIENT_CLEAR_CLIENT_RESPONSE::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::~cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST() {
}
uint8_t& cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::isEnable() {
    return (uint8_t&)(*m_isEnable);
}

void cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(uint8_t); // isEnable
    return class_size;
...
bool cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::~cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE() {
}
void cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::get_initial_size()
{
    size_t class_size = 0;
    return class_size;
}

bool cACTION_BML_SET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::~cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST() {
}
void cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::get_initial_size()
{
    size_t class_size = 0;
    return class_size;
}

bool cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::~cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE() {
}
uint8_t& cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::isEnable() {
    return (uint8_t&)(*m_isEnable);
}

void cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(uint8_t); // isEnable
    return class_size;
...
bool cACTION_BML_GET_CLIENT_ROAMING_11K_SUPPORT_RESPONSE::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::~cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST() {
}
sMacAddr& cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::radio_mac() {
    return (sMacAddr&)(*m_radio_mac);
}

int8_t& cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::channel_pool_size() {
    return (int8_t&)(*m_channel_pool_size);
}

uint8_t* cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::channel_pool(size_t idx) {
...
bool cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::set_channel_pool(const void* buffer, size_t size) {
    if (buffer == nullptr) {
        TLVF_LOG(WARNING) << "set_channel_pool received a null pointer.";
        return false;
    }
    if (size > beerocks::message::SUPPORTED_CHANNELS_LENGTH) {
...
void cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
    m_radio_mac->struct_swap();
}

bool cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(sMacAddr); // radio_mac
    class_size += sizeof(int8_t); // channel_pool_size
    class_size += beerocks::message::SUPPORTED_CHANNELS_LENGTH * sizeof(uint8_t); // channel_pool
    return class_size;
}

bool cACTION_BML_SET_SELECTION_CHANNEL_POOL_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
    ...
    if (!m_parse__) { m_radio_mac->struct_init(); }
    m_channel_pool_size = reinterpret_cast<int8_t*>(m_buff_ptr__);
    if (!m_parse__) *m_channel_pool_size = 0x0;
    if (!buffPtrIncrementSafe(sizeof(int8_t))) {
        LOG(ERROR) << "buffPtrIncrementSafe(" << std::dec << sizeof(int8_t) << ") Failed!";
        return false;
    }
    m_channel_pool = reinterpret_cast<uint8_t*>(m_buff_ptr__);
    if (!buffPtrIncrementSafe(sizeof(uint8_t) * (beerocks::message::SUPPORTED_CHANNELS_LENGTH))) {
        LOG(ERROR) << "buffPtrIncrementSafe(" << std::dec << sizeof(uint8_t) * (beerocks::message::SUPPORTED_CHANNELS_LENGTH) << ") Failed!";
        return false;
    }
    m_channel_pool_idx__  = beerocks::message::SUPPORTED_CHANNELS_LENGTH;
    if (m_parse__) { class_swap(); }
    return true;
}

cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::~cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE() {
}
uint8_t& cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::success() {
    return (uint8_t&)(*m_success);
}

void cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::get_initial_size()
{
    size_t class_size = 0;
...
bool cACTION_BML_SET_SELECTION_CHANNEL_POOL_RESPONSE::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::~cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST() {
}
sMacAddr& cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::radio_mac() {
    return (sMacAddr&)(*m_radio_mac);
}

void cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
    m_radio_mac->struct_swap();
}

bool cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(sMacAddr); // radio_mac
    return class_size;
...
bool cACTION_BML_GET_SELECTION_CHANNEL_POOL_REQUEST::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
...
cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE(uint8_t* buff, size_t buff_len, bool parse) :
    BaseClass(buff, buff_len, parse) {
    m_init_succeeded = init();
}
cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE(std::shared_ptr<BaseClass> base, bool parse) :
BaseClass(base->getBuffPtr(), base->getBuffRemainingBytes(), parse){
    m_init_succeeded = init();
}
cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::~cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE() {
}
uint8_t& cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::success() {
    return (uint8_t&)(*m_success);
}

int8_t& cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::channel_pool_size() {
    return (int8_t&)(*m_channel_pool_size);
}

uint8_t* cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::channel_pool(size_t idx) {
    if ( (m_channel_pool_idx__ == 0) || (m_channel_pool_idx__ <= idx) ) {
        TLVF_LOG(ERROR) << "Requested index is greater than the number of available entries";
        return nullptr;
    }
...
bool cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::set_channel_pool(const void* buffer, size_t size) {
    if (buffer == nullptr) {
        TLVF_LOG(WARNING) << "set_channel_pool received a null pointer.";
        return false;
    }
...
void cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::class_swap()
{
    tlvf_swap(8*sizeof(eActionOp_BML), reinterpret_cast<uint8_t*>(m_action_op));
}

bool cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::finalize()
{
    if (m_parse__) {
        TLVF_LOG(DEBUG) << "finalize() called but m_parse__ is set";
        return true;
...
size_t cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::get_initial_size()
{
    size_t class_size = 0;
    class_size += sizeof(uint8_t); // success
    class_size += sizeof(int8_t); // channel_pool_size
...
bool cACTION_BML_GET_SELECTION_CHANNEL_POOL_RESPONSE::init()
{
    if (getBuffRemainingBytes() < get_initial_size()) {
        TLVF_LOG(ERROR) << "Not enough available space on buffer. Class init failed";
        return false;
